use crate::{my_rwlock::MyRwLock, value::Something};
use std::{
    collections::HashMap,
    hash::Hash,
...
pub struct Database {
    last_table_id: usize,
    tables: HashMap<usize, MyRwLock<Table>>,
}
